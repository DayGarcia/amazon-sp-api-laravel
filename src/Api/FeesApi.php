...
use DayGarcia\AmazonSPApiLaravel\Models\ProductFees\GetMyFeesEstimateResponse;
...
class FeesApi
{
     ...
     *
     * @param \DayGarcia\AmazonSPApiLaravel\Models\ProductFees\GetMyFeesEstimateRequest $body body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\ProductFees\GetMyFeesEstimateResponse
     */
     ...
     *
     * @param \DayGarcia\AmazonSPApiLaravel\Models\ProductFees\GetMyFeesEstimateRequest $body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\ProductFees\GetMyFeesEstimateResponse, HTTP status code, HTTP response headers (array of strings)
     */
