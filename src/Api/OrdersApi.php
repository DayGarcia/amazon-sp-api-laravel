...
use DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderAddressResponse;
use DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderBuyerInfoResponse;
use DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsBuyerInfoResponse;
use DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsResponse;
use DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderResponse;
use DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrdersResponse;
...
class OrdersApi
{
     ...
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderResponse
     */
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderResponse';
        $request = $this->getOrderRequest($order_id);
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderAddressResponse
     */
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderAddressResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderAddressWithHttpInfo($order_id)
    {
        $returnType = '\DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderAddressResponse';
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderBuyerInfoResponse
     */
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderBuyerInfoResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsResponse
     */
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsResponse';
        $request = $this->getOrderItemsRequest($order_id, $next_token);
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsBuyerInfoResponse
     */
     ...
     * @throws \DayGarcia\AmazonSPApiLaravel\ApiException on non-2xx response
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsBuyerInfoResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrderItemsBuyerInfoResponse';
        $request = $this->getOrderItemsBuyerInfoRequest($order_id, $next_token);
     ...
     * @throws \InvalidArgumentException
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrdersResponse
     */
     ...
     *
     * @param string[] $marketplace_ids             A list of MarketplaceId values. Used to select orders that were placed in the specified marketplaces. (required)
     * @param string   $created_after               A date used for selecting orders created after (or at) a specified time. Only orders placed after the specified time are returned. Either the CreatedAfter parameter or the LastUpdatedAfter parameter is required. Both cannot be empty. The date must be in ISO 8601 format. (required if LastUpdatedAfter is not specified) (optional)
     * @param string   $created_before              A date used for selecting orders created before (or at) a specified time. Only orders placed before the specified time are returned. The date must be in ISO 8601 format. (optional)
     * @param string   $last_updated_after          A date used for selecting orders that were last updated after (or at) a specified time. An update is defined as any change in order status, including the creation of a new order. Includes updates made by Amazon and by the seller. The date must be in ISO 8601 format. (optional)
     * @param string   $last_updated_before         A date used for selecting orders that were last updated before (or at) a specified time. An update is defined as any change in order status, including the creation of a new order. Includes updates made by Amazon and by the seller. The date must be in ISO 8601 format. (optional)
     * @param string[] $order_statuses              A list of OrderStatus values used to filter the results. Possible values: PendingAvailability (This status is available for pre-orders only. The order has been placed, payment has not been authorized, and the release date of the item is in the future.); Pending (The order has been placed but payment has not been authorized); Unshipped (Payment has been authorized and the order is ready for shipment, but no items in the order have been shipped); PartiallyShipped (One or more, but not all, items in the order have been shipped); Shipped (All items in the order have been shipped); InvoiceUnconfirmed (All items in the order have been shipped. The seller has not yet given confirmation to Amazon that the invoice has been shipped to the buyer.); Canceled (The order has been canceled); and Unfulfillable (The order cannot be fulfilled. This state applies only to Multi-Channel Fulfillment orders.). (optional)
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrdersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($marketplace_ids, $created_after = null, $created_before = null, $last_updated_after = null, $last_updated_before = null, $order_statuses = null, $fulfillment_channels = null, $payment_methods = null, $buyer_email = null, $seller_order_id = null, $max_results_per_page = null, $easy_ship_shipment_statuses = null, $next_token = null, $amazon_order_ids = null)
    {
        $returnType = '\DayGarcia\AmazonSPApiLaravel\Models\Orders\GetOrdersResponse';
