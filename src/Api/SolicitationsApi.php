...
use DayGarcia\AmazonSPApiLaravel\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse;
use DayGarcia\AmazonSPApiLaravel\Models\Solicitations\GetSolicitationActionsForOrderResponse;
...
class SolicitationsApi
{
     ...
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DayGarcia\AmazonSPApiLaravel\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse';
        $request = $this->createProductReviewAndSellerFeedbackSolicitationRequest($amazon_order_id, $marketplace_ids);
     ...
     * @throws \InvalidArgumentException
     *
     * @return \DayGarcia\AmazonSPApiLaravel\Models\Solicitations\GetSolicitationActionsForOrderResponse
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \DayGarcia\AmazonSPApiLaravel\Models\Solicitations\GetSolicitationActionsForOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DayGarcia\AmazonSPApiLaravel\Models\Solicitations\GetSolicitationActionsForOrderResponse';
        $request = $this->getSolicitationActionsForOrderRequest($amazon_order_id, $marketplace_ids);
