...
class ListAllFulfillmentOrdersResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'next_token' => 'string',
        'fulfillment_orders' => '\DayGarcia\AmazonSPApiLaravel\Models\FulfillmentOutbound\FulfillmentOrder[]',
    ];
     ...
     *
     * @param \DayGarcia\AmazonSPApiLaravel\Models\FulfillmentOutbound\FulfillmentOrder[] $fulfillment_orders an array of fulfillment order information
     *
     * @return $this
     */
