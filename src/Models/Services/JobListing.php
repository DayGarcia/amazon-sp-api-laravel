...
class JobListing implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'jobs' => '\DayGarcia\AmazonSPApiLaravel\Models\Services\ServiceJob[]',
    ];
     ...
     * Sets jobs.
     *
     * @param \DayGarcia\AmazonSPApiLaravel\Models\Services\ServiceJob[] $jobs list of job details for the given input
     *
     * @return $this
     */
