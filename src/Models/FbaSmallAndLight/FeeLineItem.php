...
class FeeLineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fee_type' => 'string',
        'fee_charge' => '\DayGarcia\AmazonSPApiLaravel\Models\FbaSmallAndLight\MoneyType',
    ];
     ...
     * Sets fee_charge.
     *
     * @param \DayGarcia\AmazonSPApiLaravel\Models\FbaSmallAndLight\MoneyType $fee_charge fee_charge
     *
     * @return $this
     */
