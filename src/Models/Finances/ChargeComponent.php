...
class ChargeComponent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'charge_type' => 'string',
        'charge_amount' => '\DayGarcia\AmazonSPApiLaravel\Models\Finances\Currency',
    ];
     ...
     * Sets charge_amount.
     *
     * @param \DayGarcia\AmazonSPApiLaravel\Models\Finances\Currency $charge_amount charge_amount
     *
     * @return $this
     */
